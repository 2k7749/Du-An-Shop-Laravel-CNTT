        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                @php
                    ...
                    if ($admin_name) {
                       echo '<span class="username">',$admin_name,'</span>';
                    }
                @endphp
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{URL::to('/sc_admin-logout')}}"><i class="fa fa-key"></i> Đăng xuất</a></li>
            </ul>
        </li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{URL::to('/sc_admin-dashboard')}}">

...
<div class="grid grid-cols-12 gap-6 mt-5">
  <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
      <button class="button text-white bg-theme-1 shadow-md mr-2"><a href="{{URL::to('/sc_admin/add-categoryproduct')}}">Thêm mới danh mục</a></button>
  ...
  <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
      <table class="table table-report -mt-2">
          <thead>
              <tr>
                  <th class="whitespace-no-wrap">Tên danh mục</th>
          ...
          <tbody>
            ...
            @foreach($all_categoryproduct as $key => $cate_pro)
              <tr class="intro-x">
                  <td>
                      <a href="" class="font-medium whitespace-no-wrap">{{ $cate_pro->category_name }}</a> 
                      <div class="text-gray-600 text-xs whitespace-no-wrap"><?php echo $cate_pro->category_desc;?> </div>
                  </td>
                  <td class="w-40">
                    ...
                    ?>
                        <div class="text-center flex items-center justify-center text-theme-6"> 
                          <a href="{{URL::to('/sc_admin/active-categoryproduct/'.$cate_pro->category_id)}}"><i data-feather="check-square" class="w-4 h-4 mr-2"></i>  Không hiển thị</a>  
                        </div>
                    <?php
                      }else{
                    ?>
                          ...
                          <div class="text-center flex items-center justify-center text-theme-9"> 
                            <a href="{{URL::to('/sc_admin/unactive-categoryproduct/'.$cate_pro->category_id)}}"><i data-feather="check-square" class="w-4 h-4 mr-2"></i>  Hiển thị</a>  
                          </div>
                    <?php
                      }
                    ?>
                  ...
                  <td class="table-report__action w-56">
                      <div class="flex justify-center items-center">
                          <a class="flex items-center mr-3" href="{{URL::to('/sc_admin/edit-categoryproduct/'.$cate_pro->category_id)}}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Sửa </a>
...
<div class="modal" id="delete-confirmation-modal">
  <div class="modal__content">
      ...
      <div class="px-5 pb-8 text-center">
          ...
          <button type="button" class="button w-24 bg-theme-6 text-white"><a href="{{URL::to('/sc_admin/delete-categoryproduct/'.$cate_pro->category_id)}}">Xoá luôn</a></button>

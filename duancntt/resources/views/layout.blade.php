...
<body class="animsition">
			...
			<div class="header-cart-content flex-w js-pscroll">
						...
						<li class="header-cart-item flex-w flex-t m-b-12">
							...
							<div class="header-cart-item-txt p-t-8">
								...
								<span class="header-cart-item-info">
									{{$item->qty}} x {{number_format($item->price).' VNĐ'}}
								</span>
							</div>
						</li>
						@endforeach
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						...
						<?php }else{ ?>
							<a href="{{URL::to('/login-checkout')}}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
								Check Out
							</a>
					<?php } ?>
	...
	{{-- <section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url({{asset('public/frontend/images/slide-01.jpg')}});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="#show-now" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
				...
				<div class="item-slick1" style="background-image: url({{asset('public/frontend/images/slide-02.jpg')}});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url({{asset('public/frontend/images/slide-03.jpg')}});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
